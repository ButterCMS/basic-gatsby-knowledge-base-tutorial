...
## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [Building a Knowledge Base with Gatsby and ButterCMS](https://buttercms.com/blog/simple-gatsby-knowledge-base-tutorial/), and will not be actively maintained.
